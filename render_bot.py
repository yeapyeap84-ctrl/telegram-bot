...
Оптимизированная версия для бесплатного хостинга
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.StreamHandler()  # Только в консоль для Render
    ]
)
...
class Scheduler:
    ...
    def publish_scheduled_post(self, time_str: str):
        ...
        # Запускаем публикацию в новом цикле событий
...
def test_publish():
    ...
    async def test():
        ...
        message = "🧪 Тестовое сообщение с Render"
...
def main():
    """Основная функция"""
    logger.info("🤖 Запуск Telegram бота для Render")
